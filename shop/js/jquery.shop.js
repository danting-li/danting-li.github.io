(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.paypalBusinessEmail = "liz.danting.li@gmail.com"; // Your Business PayPal's account email address
			this.paypalURL = "https://paypal.me/atapayphone?locale.x=zh_XC"; // The URL of the PayPal's form
